/******************************************************************************\
* This file was moved to the attic on 2010-03-30. The functionality provided   *
* was never put into widespread use and is now obsolete. The functionality in  *
* mission_conf.i supercedes this.                                              *
\******************************************************************************/

/* The following text was previously found in doc/conf_template.conf:
