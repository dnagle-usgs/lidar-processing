...
Usage:
 	mkidx somefile.tld somefile.idx


The index file consists of:

   BBBB_BBBB	len	  32 bit count of records in this index

   CCCC_CCCC    ras_off   32 bit offset to the raster header
   DDDD_DDDD    pulse_off 32 bit offset to the pulse data
