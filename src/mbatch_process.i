...
write, "mbatch_process_i: starting\n";
require, "eaarl.i";
write, "mbatch_process_i: eaarl.i - invoked\n";
write, "$Id$";
/*
   ...
   if (is_array(r)) {
      ...
      if (auto) {
         ...
         if (bool_arr(indx_number) != 1) {
            ...
            write, f, format="range_biasNS: %f\n\n",ops_conf.range_biasNS;
