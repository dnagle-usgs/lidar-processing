/******************************************************************************\
* This file was created in the attic on 2010-02-19. It contains code from      *
* ytriangulate.i that has become obsolete. These structs have been removed:    *
*     ITRIANGLE                                                                *
*     IEDGE                                                                    *
*     XYZ                                                                      *
...
*     triangulate_xyz                                                          *
*     grid_triag_data                                                          *
* Details for the removals accompany the code below.                           *
\******************************************************************************/

/*
   The structs below are only used within the removed functions further below.
   They had no purpose or use outside of that.
*/
...
/*
   This Yorick function is replaced by triangulate, which uses C-ALPS to do the
   same task.
*/
...
/*
   CircumCircle was only used by ytriangulate.
*/
/*
...
*/
  ...
  v = triangulate(xyz(1,), xyz(2,), verbose=1);
