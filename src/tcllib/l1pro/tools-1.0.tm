...
if {![namespace exists ::l1pro::tools::histelev]} {
   ...
   namespace eval ::l1pro::tools::histelev::v {
...
proc ::l1pro::tools::histelev::gui {} {
   ...
   set colors {black white red green blue cyan magenta yellow}
   set types {solid dash dot dashdot dashdotdot}
   set labels [list]

   ttk::labelframe $w.general \
   ...
   ttk::label $f.lblwidth -text "Line width: "
   ttk::label $f.lbltype -text "Line type: "
   ::misc::combobox $f.kernel -state readonly \
   ...
   grid $f.kernel $f.bandwidth $f.sample $f.color $f.width $f.type -sticky ew
