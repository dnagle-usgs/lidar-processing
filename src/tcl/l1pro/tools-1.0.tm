...
namespace eval ::l1pro::tools::rollbias {
   namespace eval v {
   ...
   proc help {} {
      ...
      $w.doc ins end \
         "1.\tStart with point data plotted in a window and raw EAARL data\
         loaded. Set the variable and window and click \"Get Transect\".\
         ...
         \n3.\tClick the \"Plot\" button to display the loaded transect. In\
         ...
         \n4.\tClick \"Select Flightlines\" and simply type \"y\" or \"n\" to\
         keep or remove each flightline. Now you have a set of flightlines\
         going the same direction.\
         \n5.\tDetermine whether the flightlines are going into or out of the\
         screen. If they are going INTO the screen, check the \"into screen\"\
         box. If they are going OUT OF the screen, uncheck the \"into screen\"\
         box.\
   ...
   proc determine_bias {} {
      exp_send "goodroll = find_roll_bias(transdata, 0, $v::inout, update=1);\r"
   }
}
