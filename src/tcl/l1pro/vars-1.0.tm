...
snit::widget ::l1pro::vars::gui::load_from_file {
    ...
    method {Construct select} {} {
        ...
        ttk::label $f.msg -justify left -anchor w -text \
                "Select a source file, then select one or more variables from\
                that file that you'd like to import."
        ...
        ttk::scrollbar $f.scrTree -orient vertical \
                -command [list $f.treeVars yview]
    ...
    method {Construct import} {} {
        ...
        ttk::label $f.msg -justify left -anchor w -text \
                "For each of the variables you have selected, you can choose\
                the name you wish to import it as. Or, you can leave it as-is\
                to accept the variable's name as found in the file."
        bind $f.msg <Configure> {%W configure -wraplength [winfo width %W]}
        ...
        ttk::button $f.btnImport -text "Load" -command [mymethod load]
...
snit::widget ::l1pro::vars::gui::save_to_file {
    ...
    method {Construct select} {} {
        ...
        ttk::label $f.msg -justify left -anchor w -text \
                "Select one or more variables from that file that you'd like\
                to save."
        bind $f.msg <Configure> {%W configure -wraplength [winfo width %W]}
    ...
    method {Construct export} {} {
        ...
        ttk::label $f.msg -justify left -anchor w -text \
                "Select the destination you would like to save the variables\
                to. Also, for each of the variables you have selected, you can\
                choose the name you wish to save it as. Or, you can leave it\
                as-is to accept the variable's name as found in the file."
        bind $f.msg <Configure> {%W configure -wraplength [winfo width %W]}
        ...
        ttk::button $f.btnPrev -text "<- Previous" \
                -command [mymethod swap to select]
        ttk::button $f.btnCancel -text "Cancel" -command [mymethod cancel]
        ttk::button $f.btnImport -text "Save" -command [mymethod save]
...
snit::widgetadaptor ::l1pro::vars::gui::vartree {
    ...
    method {Update varinfo} {option value} {
        ...
        foreach {var info} $value {
            ...
            $self insert {} end -id $var \
                    -values [list $var $structof $dimsof $sizeof]
        }
    }
}
